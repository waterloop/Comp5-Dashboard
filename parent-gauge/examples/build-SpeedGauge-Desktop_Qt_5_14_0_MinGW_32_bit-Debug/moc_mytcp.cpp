...
QT_MOC_LITERAL(1, 6, 15), // "readyReadCustom"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 11) // "readTCPData"

    },
    "MyTCP\0readyReadCustom\0\0readTCPData"
};
...
void MyTCP::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->readyReadCustom(); break;
        ...
        {
            using _t = void (MyTCP::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTCP::readyReadCustom)) {
                *result = 0;
                return;
            }
        }
