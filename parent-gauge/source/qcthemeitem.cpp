    ...
    while(!inputFile.atEnd()){
        ...
        if(temp.length() > 2){
            if (!(temp[0] == '/' && temp[1]=='/')){
                ...
                else if (first == "labelAngle"){
                    labelAngle = static_cast<qreal>(second.toDouble());
                }
                else if (first == "labelFont"){
                    bool start = false;
                    QString tempFont;
                ...
                else if (first =="needleLabelPosition"){
                    needleLabelPosition = static_cast<qreal>(second.toDouble());
                }
                else if (first == "needleLabelAngle"){
                    needleLabelAngle = static_cast<qreal>(second.toDouble());
                }
                ...
                else if (first == "colorBandDynamic"){
                    if (second == "false"){
                ...
                else if (first == "dynamicColorArcCust"){
                    if (second == "false"){
